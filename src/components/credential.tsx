...
export function Credential({ image, onExpandQRCode, onChangeAvatar }: Props){
  return(
    <View className="w-full self-stretch items-center">
      ...
      <View className="bg-black/20 self-stretch items-center pb-6 border 
      border-white/10 mx-3 rounded-2xl -mt-5">
        ...
        {image ? (
          ...
          <TouchableOpacity activeOpacity={0.9} className="w-36 h-36 
